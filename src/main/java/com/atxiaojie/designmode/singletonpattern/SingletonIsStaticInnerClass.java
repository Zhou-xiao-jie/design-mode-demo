...
/**
 * @ClassName: SingletonIsStaticInnerClass
 ...
 * @Version: V1.0.0
 */
public class SingletonIsStaticInnerClass {
    private static class SingletonHolder {
        private static final SingletonIsStaticInnerClass INSTANCE = new SingletonIsStaticInnerClass();
    }
    private SingletonIsStaticInnerClass (){}
    public static final SingletonIsStaticInnerClass getInstance() {
        return SingletonHolder.INSTANCE;
    }

    public void showMessage(){
        System.out.println("SingletonIsStaticInnerClass Hello World!");
    }
}
